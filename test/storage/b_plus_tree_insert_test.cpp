...
TEST(BPlusTreeTests, InsertTest1) {
  ...
  // std::cout<<comparator(root_as_leaf->KeyAt(0), index_key)<<std::endl;
...
//     index_key.SetFromInteger(key);
//     tree.GetValue(index_key, &rids);
//     // printf("%ld %d %d\n",key,tree.FindLeafPage(index_key)->GetPageId(),tree.FindLeafPage(index_key)->GetNextPageId());
